...
const theNFT = await stdlib.launchToken(accCreator, "sooja", "SJA", {supply: 1})
...
const startBidders = async () => {
    ...
    const runBidder = async (who) => {
        ...
        try{
            ...
            const vBid = await ctc.unsafeView.currentBid();
            ...
            console.log(`${who} put bid ${stdlib.formatAddress(lastBidder)} who bid ${stdlib.formatCurrency(lastBid)}.`);
        } catch(e){
